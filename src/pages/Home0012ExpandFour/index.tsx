...
const Home0012ExpandFourPage: React.FC = () => {
            ...
            <div className="flex md:flex-col flex-row gap-[18px] items-center justify-between mt-11 w-full">
              <div className="flex md:flex-1 flex-col gap-[23px] items-end justify-start w-3/4 md:w-full">
                <div className="flex flex-col items-center justify-start w-[92%] md:w-full">
                  ...
                  <div
                    className="common-pointer flex flex-col gap-3.5 items-start justify-start mt-[23px] w-full"
                    onClick={() => navigate("/home0012expandthree")}
                  >
                    <Text
                      className="md:ml-[0] ml-[3px] text-black_900 text-left w-auto"
                      as="h2"
                    ...
                    <Input
                      wrapClassName="flex h-[43px] w-full"
                      className="p-0 w-full"
                      name="rectangleThirtyNine"
                      placeholder=""
                      variant="FillBluegray50"
                    ></Input>
                  </div>
                  <div
                    className="common-pointer flex flex-col gap-3.5 items-start justify-start mt-[13px] w-full"
                    onClick={() => navigate("/home0012expandthree")}
                  >
                    <Text
                      className="md:ml-[0] ml-[3px] text-black_900 text-left w-auto"
...
export default Home0012ExpandFourPage;
