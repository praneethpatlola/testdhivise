...
const Home0012ExpandSixPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 font-roboto h-[750px] mx-auto relative w-full">
        <div className="absolute bg-gray_50 flex flex-col h-full inset-y-[0] items-end justify-end my-auto p-1.5 md:px-5 right-[0] w-[94%]">
              ...
              <div className="flex md:flex-col flex-row gap-[38px] items-center justify-between w-full">
                ...
                <div className="flex md:flex-1 flex-col items-center justify-start w-[12%] md:w-full">
                  <div className="flex flex-col gap-[5px] items-end justify-start w-full">
                    ...
                    <div className="bg-blue_600 flex flex-col items-center justify-start p-3 rounded-lg w-full">
                      <Text
                        className="text-black_900 text-left"
                        as="h5"
                        variant="h5"
                      ></Text>
                    </div>
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] items-center justify-end max-w-[935px] mx-auto md:px-5 w-full">
          <div className="flex flex-col items-center justify-start w-full">
            ...
            <div className="md:h-[473px] h-[540px] mt-1 relative w-full">
              <div className="md:h-[469px] h-[540px] m-auto w-full">
                <div className="absolute bg-white_A700 h-[469px] inset-x-[0] mx-auto rounded-lg shadow-bs top-[0] w-full"></div>
                <div className="absolute bottom-[0] flex flex-col gap-[17px] inset-x-[0] items-center justify-start mx-auto w-full">
                  <List
                    className="flex-col gap-2.5 grid items-center w-full"
                      ...
                      <div className="flex flex-col gap-[19px] items-center justify-start w-full">
                        <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-[97%] md:w-full">
                          ...
                          <Home0011OneAvatardefault
                            ...
                            elipse="images/img_group107.png"
                          />
                          <Text
                          ...
                          <Text
                            className="md:ml-[0] ml-[71px] text-gray_500 text-left w-auto"
                            as="h4"
                            variant="h4"
                          >
                            Product Designer
                          ...
                          <Img
                            ...
                            className="h-6 md:ml-[0] ml-[88px] w-6"
                            alt="overflowmenu"
                          />
                        </div>
                  ...
                  <List
                    className="flex-col gap-[13px] grid items-center w-full"
                    orientation="vertical"
                  >
              ...
              <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[5%] w-[77%]">
        ...
        <Sidebar1 className="absolute flex flex-col md:hidden inset-y-[0] justify-start left-[0] my-auto md:px-5 w-[13%]" />
      </div>
    </>
  );
};

export default Home0012ExpandSixPage;
